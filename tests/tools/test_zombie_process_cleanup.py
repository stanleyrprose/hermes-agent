...
class TestGatewayCleanupWiring:
    ...
    def test_gateway_stop_calls_close(self):
        ...
        runner._stop_task = None  # must be None to skip the early-return path
        # Mock async methods that would otherwise return unmockable MagicMock
        ...
        runner._cancel_background_tasks = AsyncMock()
